const DB = {
  get products() {
    return (
      JSON.parse(localStorage.getItem("ww_products_v3") || "null") ||
      defaultProducts()
    );
  },
  set products(v) {
...
const CATEGORIES = {
  amigurumi: { label: "Amigurumi", icon: "\u{1F9F8}", subs: ["Teddy Bear", "Bunny", "Cat", "Dog", "Duck", "Frog", "Penguin"] },
  flowers: { label: "Crochet Flowers & Plants", icon: "\u{1F33B}", subs: ["Roses", "Tulips", "Sunflowers", "Daisies", "Lavender", "Small Potted Plants"] },
  fashion: { label: "Crochet Fashion", icon: "\u{1F457}", subs: ["Sweaters", "Cardigans", "Tops", "Skirts", "Scarves", "Hats", "Gloves"] },
  bags: { label: "Crochet Bags & Accessories", icon: "\u{1F45C}", subs: ["Tote Bags", "Mini Handbags", "Shoulder Bags", "Coin Purses", "Phone Pouches", "Keychains"] },
  home: { label: "Crochet Home Decor", icon: "\u{1F3E0}", subs: ["Blankets", "Cushion Covers", "Rugs", "Coasters", "Table Runners", "Wall Decorations"] },
  food: { label: "Crochet Food", icon: "\u{1F353}", subs: ["Strawberry", "Cupcake", "Donut", "Cake", "Pizza", "Coffee Cup", "Ice Cream"] },
  toys: { label: "Crochet Toys", icon: "\u{1F9F8}", subs: ["Dolls", "Soft Toys", "Dolls' Clothes", "Miniature Toys", "Crochet Vehicles"] },
  jewelry: { label: "Crochet Jewelry", icon: "\u{1F48D}", subs: ["Bracelets", "Earrings", "Necklaces", "Rings", "Hair Accessories"] },
  seasonal: { label: "Crochet Seasonal & Festive", icon: "\u{1F384}", subs: ["Christmas Ornaments", "Halloween Pumpkins", "Valentine's Hearts", "Easter Eggs", "Snowflakes", "Christmas Trees"] },
  miniature: { label: "Miniature Crochet", icon: "\u{2728}", subs: ["Mini Bags", "Mini Food", "Mini Animals", "Mini Flowers", "Tiny Clothes", "Tiny Room Decorations"] },
};
